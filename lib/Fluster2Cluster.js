...
{	
	...
	this.show = function()
	{
		if(this.markers.length == 1 											// Only 1 marker
			|| this.markers.length < this.fluster.minimumClusterSize			// Fewer markers than minimum amount
			|| this.fluster.currentZoomLevel > this.fluster.maximumZoomLevel)	// Zoom level to high
		{
			// Show all clusters if only one or too few
